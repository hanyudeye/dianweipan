...
class InitController extends \common\components\ConsoleController
{
    ...
    public function actionHq()
    {
        ...
        while (true) {
			$cnt++;
            echo exec('/www/wdlinux/phps/56/bin/php /www/web/100gift/public_html/yii init/gather2');
            echo exec('/www/wdlinux/phps/56/bin/php /www/web/100gift/public_html/yii init/gather');
            sleep(1);
			if($cnt>60)break;
        }
    }
